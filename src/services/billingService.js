...
const PRICE_TO_LINK = {
  ...
  [STRIPE_PRICES.EMP_ELITE_MONTHLY]:  STRIPE_LINKS.EMP_ELITE_MONTHLY,
  [STRIPE_PRICES.EMP_ELITE_YEARLY]:   STRIPE_LINKS.EMP_ELITE_YEARLY,
  [STRIPE_PRICES.WORKER_PRO_MONTHLY]: STRIPE_LINKS.WORKER_PRO_MONTHLY,
  [STRIPE_PRICES.WORKER_PRO_YEARLY]:  STRIPE_LINKS.WORKER_PRO_YEARLY,
}
