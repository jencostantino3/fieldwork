...
export default function Login() {
  ...
  async function onResetSubmit({ email }) {
    setErr('')
    try {
          ...
          {mode === 'reset' ? (
            resetSent ? (
              <div className="text-center py-2">
                ...
                <button onClick={backToLogin} className="text-athleticBlue text-sm font-medium hover:underline">
                  Back to sign in
                </button>
              </div>
            ) : (
              <form onSubmit={resetForm.handleSubmit(onResetSubmit)} className="space-y-4">
                ...
                <Button type="submit" fullWidth size="lg" loading={resetForm.formState.isSubmitting}>
                  Send Reset Link
                </Button>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <button
                      type="button"
                      onClick={() => { setErr(''); setMode('reset') }}
                      className="text-xs text-athleticBlue font-medium hover:underline"
                    >
                      Forgot password?
                    </button>
                  </div>
